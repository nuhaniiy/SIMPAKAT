...
import com.nurul.simpakat.view.dekan.proker.AddProkerDekanFragment;
 ...
 */
public class AddPengajuanDekanFragment extends AbstractFragmentView<PengajuanModel> implements PengajuanView {
    ...
    public AddPengajuanDekanFragment() {
    ...
    public static AddPengajuanDekanFragment newInstance() {
        AddPengajuanDekanFragment fragment = new AddPengajuanDekanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_add_pengajuan_dekan, container, false);
                ...
                try {
                    ...
                    try {
                        ...
                        if(TextUtils.equalIgnoreCase(json.getString("resultCode"), Constanta.OK)) {
                            ...
                            Log.d("respond","data proker : " + json.getString("data_proker"));
...
//            super.viewModel.setIdProker(idProgramKerja[0]);
    ...
    private void showLayoutSuccess() {
        AddPengajuanDekanActivity.instance().hideAppBar();
