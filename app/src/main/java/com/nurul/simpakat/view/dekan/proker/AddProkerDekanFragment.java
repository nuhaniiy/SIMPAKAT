 ...
 */
public class AddProkerDekanFragment extends AbstractFragmentView<ProkerModel> implements ProkerView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_add_proker_dekan, container, false);
    ...
    private void showLayoutSuccess() {
        AddProkerDekanActivity.instance().hideAppBar();
