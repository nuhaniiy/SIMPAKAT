 ...
 */
public class CrudDataKaryawanFragment extends AbstractFragmentView<SignupModel> implements SignupView {
    ...
    public static CrudDataKaryawanFragment newInstance() {
        CrudDataKaryawanFragment fragment = new CrudDataKaryawanFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public CrudDataKaryawanFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_crud_data_karyawan, container, false);
